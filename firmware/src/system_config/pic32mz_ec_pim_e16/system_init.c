...
void SYS_Initialize ( void* data )
{
    ...
    SYS_INT_VectorPrioritySet(INT_VECTOR_DMA4, INT_PRIORITY_LEVEL5);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_DMA4, INT_SUBPRIORITY_LEVEL0);
    SYS_INT_VectorPrioritySet(INT_VECTOR_DMA5, INT_PRIORITY_LEVEL5);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_DMA5, INT_SUBPRIORITY_LEVEL0);
    SYS_INT_VectorPrioritySet(INT_VECTOR_DMA6, INT_PRIORITY_LEVEL5);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_DMA6, INT_SUBPRIORITY_LEVEL0);
    SYS_INT_VectorPrioritySet(INT_VECTOR_DMA7, INT_PRIORITY_LEVEL5);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_DMA7, INT_SUBPRIORITY_LEVEL0);
    ...
    SYS_INT_SourceEnable(INT_SOURCE_DMA_4);
    SYS_INT_SourceEnable(INT_SOURCE_DMA_5);
    SYS_INT_SourceEnable(INT_SOURCE_DMA_6);
    SYS_INT_SourceEnable(INT_SOURCE_DMA_7);
